\doxysection{include/utils/management.h File Tham chiếu}
\hypertarget{management_8h}{}\label{management_8h}\index{include/utils/management.h@{include/utils/management.h}}
...
\begin{DoxyCompactList}\small\item\em Mã trạng thái thêm thành công. \end{DoxyCompactList}\item 
\Hypertarget{management_8h_adba71ee53474d8e915228b871ee314dc}\label{management_8h_adba71ee53474d8e915228b871ee314dc} 
\#define {\bfseries UPDATE\+\_\+\+FAILED}~0
\begin{DoxyCompactList}\small\item\em Mã trạng thái cập nhật thất bại. \end{DoxyCompactList}\item 
\Hypertarget{management_8h_ab0f48f2bf0db37d7e5e9ba2f6890bde4}\label{management_8h_ab0f48f2bf0db37d7e5e9ba2f6890bde4} 
\#define {\bfseries UPDATE\+\_\+\+SUCCESS}~1
\begin{DoxyCompactList}\small\item\em Mã trạng thái cập nhật thành công. \end{DoxyCompactList}\item 
\Hypertarget{management_8h_ab034727e78d0bce5a231ecd3f7f5ec71}\label{management_8h_ab034727e78d0bce5a231ecd3f7f5ec71} 
\#define {\bfseries UPDATE\+\_\+\+FILE\+\_\+\+FAILED}~2
\begin{DoxyCompactList}\small\item\em Mã trạng thái cập nhật thất bại do lỗi file. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
int \mbox{\hyperlink{management_8h_a62c26c22380dea04c7f251294534d313}{update\+\_\+content\+\_\+without\+\_\+callback}} (\mbox{\hyperlink{struct_record}{Record}} \texorpdfstring{$\ast$}{*}record, void \texorpdfstring{$\ast$}{*}content)
\begin{DoxyCompactList}\small\item\em Hàm cập nhật dữ liệu trực tiếp không thông qua gọi callback. \end{DoxyCompactList}\item 
...
\hline
\end{DoxyParams}
Edge case\Hypertarget{management_8h_acb958d60afccf032644f4d29599ed367}\index{management.h@{management.h}!read\_content@{read\_content}}
...
\hline
\end{DoxyParams}
\Hypertarget{management_8h_a62c26c22380dea04c7f251294534d313}\index{management.h@{management.h}!update\_content\_without\_callback@{update\_content\_without\_callback}}
\index{update\_content\_without\_callback@{update\_content\_without\_callback}!management.h@{management.h}}
\doxysubsubsection{\texorpdfstring{update\_content\_without\_callback()}{update\_content\_without\_callback()}}
{\footnotesize\ttfamily \label{management_8h_a62c26c22380dea04c7f251294534d313} 
int update\+\_\+content\+\_\+without\+\_\+callback (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_record}{Record}} \texorpdfstring{$\ast$}{*}}]{record}{, }\item[{void \texorpdfstring{$\ast$}{*}}]{content}{}\end{DoxyParamCaption})}



Hàm cập nhật dữ liệu trực tiếp không thông qua gọi callback. 
