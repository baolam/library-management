\doxysection{include/utils/trie.h File Tham chiếu}
\hypertarget{trie_8h}{}\label{trie_8h}\index{include/utils/trie.h@{include/utils/trie.h}}
...
void \mbox{\hyperlink{trie_8h_a4ce1af9902523c25aafd201613db71ab}{remove\+Id\+From\+Word}} (\mbox{\hyperlink{struct_trie_node}{Trie\+Node}} \texorpdfstring{$\ast$}{*}root, char \texorpdfstring{$\ast$}{*}word, int id)
\begin{DoxyCompactList}\small\item\em Hàm xoá Id khỏi quản lí. \end{DoxyCompactList}\item 
...
\hline
\end{DoxyParams}
Make sure lowercase\Hypertarget{trie_8h_ad2aa3ceb08b5c05b48b3e56bc2d2926e}\index{trie.h@{trie.h}!loadTrieTree@{loadTrieTree}}
...
\hline
\end{DoxyParams}
\Hypertarget{trie_8h_a4ce1af9902523c25aafd201613db71ab}\index{trie.h@{trie.h}!removeIdFromWord@{removeIdFromWord}}
\index{removeIdFromWord@{removeIdFromWord}!trie.h@{trie.h}}
\doxysubsubsection{\texorpdfstring{removeIdFromWord()}{removeIdFromWord()}}
{\footnotesize\ttfamily \label{trie_8h_a4ce1af9902523c25aafd201613db71ab} 
void remove\+Id\+From\+Word (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{struct_trie_node}{Trie\+Node}} \texorpdfstring{$\ast$}{*}}]{root}{, }\item[{char \texorpdfstring{$\ast$}{*}}]{word}{, }\item[{int}]{id}{}\end{DoxyParamCaption})}



Hàm xoá Id khỏi quản lí. 

Sẽ tiến hành xoá theo thứ tự ưu tiên sau\+:
\begin{DoxyItemize}
\item Xoá Id, giảm Id
\item Khi không còn dữ liệu, xoá word
\end{DoxyItemize}
