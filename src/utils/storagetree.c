...
//     msgpack_unpacker_reserve_buffer(&unpacker, file_size);
//     memcpy(msgpack_unpacker_buffer(&unpacker), buffer, file_size);
//     msgpack_unpacker_buffer_consumed(&unpacker, file_size);
...
//     {
//         tree = loadBPlusTree(&result.data);
//     }
